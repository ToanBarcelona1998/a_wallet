...
class SignedImportWalletSeedPhraseWidget extends StatelessWidget {
  ...
  const SignedImportWalletSeedPhraseWidget({
    this.wordCount = 12,
                  ...
                  children: [
                    TextSpan(
                      text: '${localization.translate(
                        LanguageKey.signedImportWalletScreenSeedPhraseTitle,
                      )}   ',
                    ),
                    TextSpan(
                      style: AppTypoGraPhy.textSmSemiBold.copyWith(
            ...
            GestureDetector(
              ...
              child: TextWithIconWidget(
                titlePath: localization.translate(
                  LanguageKey.signedImportWalletScreenPaste,
                ),
          ...
          constraintManager: ConstraintManager()
            ..custom(
              errorMessage: localization.translate(
                LanguageKey.signedImportWalletScreenInvalidPassPhrase,
              ),
              customValid: isValid,
            ),
        ),
